...
const ProductsPanel = () => {
  ...
  const offerings = [
    ...
    {
      title: "All Products",
      description: "Browse our complete collection of curated home goods, vintage clothing, art, and antiques all in one place.",
      buttonText: "Shop All",
      buttonLink: "/catalog"
    }
  ];
  ...
  return (
    <div className="relative w-full h-screen flex flex-col items-center justify-center overflow-hidden">
      ...
      <div className="relative z-10 text-center px-4 sm:px-6 lg:px-8 max-w-4xl mx-auto">
        <h2 className="text-4xl sm:text-5xl font-bold text-white mb-12 drop-shadow-lg font-markazi">
          Custom & Curated
        </h2>
